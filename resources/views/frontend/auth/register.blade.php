            ...
            <div class="row big-y">
                <div class="col-md-8 bg-col">
                    ...
                    <form class="row" action="{{ route('customer.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12">
                            <select id="inputState" class="form-select" name="caste" id="caste">
                        ...
                        <div class="col-6">
                            <input type="text" class="form-control" id="phone" name="phone" minlength="10" maxlength="10"
                                placeholder="Mobile No"  oninput="this.value = this.value.replace(/\D/g, '')">
                        </div>
                        <div class="col-6">
                        ...
                        <div class="col-12 hidden" id="children-container">
                            ...
                            <input type="number" class="form-control" id="children" name="no_of_children" placeholder="Number of Children">
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-12">
                            <input type="text" class="form-control" id="siblings" name="siblings" placeholder="Siblings">
                        </div>
                        <div class="col-12">
                            <input type="text" class="form-control" id="locations" name="locations" placeholder="Locations">
                        </div>
                        <div class="col-12">
                            <input type="text" class="form-control" name="permanent_locations" id="permanent_locations"
                        ...
                        <div class="col-12">
                            <input type="text" class="form-control" id="preferred_contact_no"  name="preferred_contact_no" minlength="10" maxlength="10"
                                placeholder="Prefered contact number to talk"
                                oninput="this.value = this.value.replace(/\D/g, '')">
                        </div>
                        <div class="col-12">
                            <select class="form-control" id="contact_related_to" name="contact_related_to" placeholder="Relation ">
