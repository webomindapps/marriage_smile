        ...
        <div class="container">
            ...
            <div class="row big-y">
                <div class="col-md-8 bg-col">
                    <form class="row" id="registrationForm" action="{{ route('admin.customer.edit', $customer->id) }}"
                        method="POST" enctype="multipart/form-data">
                        @csrf
                        <h5 class="h5-find pd-1"><i class="fas fa-user-circle"></i> Information </h5>
                        <div class="col-6">
                        ...
                        <div class="col-6">
                            <select class="form-control" id="gender" name="gender">
                                <option value="" disabled {{ empty($customer->details->gender) ? 'selected' : '' }}>
                                    Select
                                    Gender</option>
                                <option value="male" {{ $customer->details->gender == 'male' ? 'selected' : '' }}>Male
                                </option>
                                <option value="female" {{ $customer->details->gender == 'female' ? 'selected' : '' }}>Female
                                </option>
                            </select>
                        ...
                        <div class="col-6">
                            <select class="form-control" id="qualification" name="qualification" required>
                                ...
                                <option value="BE" {{ $customer->details->qualification == 'BE' ? 'selected' : '' }}>BE
                                </option>
                                <option value="B Com"
                                    {{ $customer->details->qualification == 'B Com' ? 'selected' : '' }}>B Com
                                </option>
                                <option value="B Sc" {{ $customer->details->qualification == 'B Sc' ? 'selected' : '' }}>
                                    B Sc
                                </option>
                                <option value="B Tech"
                                    {{ $customer->details->qualification == 'B Tech' ? 'selected' : '' }}>B Tech
                                </option>
                                <option value="BBA" {{ $customer->details->qualification == 'BBA' ? 'selected' : '' }}>
                                    BBA
                                </option>
                                <option value="BCA" {{ $customer->details->qualification == 'BCA' ? 'selected' : '' }}>
                                    BCA
                                </option>
                                <option value="M Sc" {{ $customer->details->qualification == 'M Sc' ? 'selected' : '' }}>
                                    M Sc
                                </option>
                                <option value="M Tech"
                                    {{ $customer->details->qualification == 'M Tech' ? 'selected' : '' }}>M Tech
                                </option>
                                <option value="MBA" {{ $customer->details->qualification == 'MBA' ? 'selected' : '' }}>
                                    MBA
                                </option>
                                <option value="MCA" {{ $customer->details->qualification == 'MCA' ? 'selected' : '' }}>
                                    MCA
                                </option>
                                <option value="Diploma"
                                    {{ $customer->details->qualification == 'Diploma' ? 'selected' : '' }}>
                                    Diploma</option>
                                <option value="ITI" {{ $customer->details->qualification == 'ITI' ? 'selected' : '' }}>
                                    ITI
                                </option>
                                <option value="Others"
                                    {{ $customer->details->qualification == 'Others' ? 'selected' : '' }}>Others
                                </option>
                                <option value="10th" {{ $customer->details->qualification == '10th' ? 'selected' : '' }}>
                                    10th
                                </option>
                                <option value="12th" {{ $customer->details->qualification == '12th' ? 'selected' : '' }}>
                                    12th
                                </option>
                            </select>
                        ...
                        <div class="form-group" id="other-qualification-field"
                            ...
                            <input type="text" class="form-control" id="other_qualification"
                                name="other_qualification" value="{{ $customer->details->other_qualification ?? '' }}"
                        ...
                        <div class="col-6">
                            <input type="text" class="form-control" id="experience" name="experience"
                                value="{{ $customer->details->experience }}" placeholder="Working Experience" required>
                            @error('experience')
                                <div class="text-danger ps-0 mb-2" style="font-size: 13px;">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-6">
                            <input type="text" class="form-control" id="father_occupation" name="father_occupation"
                                placeholder="Father Occupation" value="{{ $customer->details->father_occupation }}">
                        ...
                        <div class="col-6">
                            <input type="text" class="form-control" id="mother_occupation" name="mother_occupation"
                                placeholder="Mother Occupation" value="{{ $customer->details->mother_occupation }}">
