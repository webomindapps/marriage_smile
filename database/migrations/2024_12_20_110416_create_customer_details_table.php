...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('customer_details', function (Blueprint $table) {
            ...
            $table->string('req_rel_manager')->nullable();
            ...
            $table->string('present_house_status')->nullable();
            $table->string('permanent_locations')->nullable();
            $table->string('permanent_house_status')->nullable();
            $table->string('asset_value')->nullable();
            $table->string('preferreday')->nullable();
            $table->dateTime('timings')->nullable();
            $table->bigInteger('preferred_contact_no')->nullable();
            $table->string('contact_related_to')->nullable();
            $table->timestamps();
        });
    }
